module Servers
  class ChannelsController < BaseController
    ...
    def update
      respond_to do |format|
        if @server_channel.update(server_channel_params)
          format.html { redirect_to @server_channel, notice: "Channel was successfully updated.", status: :see_other }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to server_channels_path, notice: "Channel was successfully destroyed.", status: :see_other }
